...
close all;
load("DFT_4.mat")
DFT_SIM = DFT_4; % The response of SIM, which has been optimized by using the gradient descent algorithm
...
N_snapshot = 32; % Number of snapshots for each discrete bin, i.e., T_x and T_y in (25)
...
for ii = 1 : N_snapshot
    for jj = 1 : N_snapshot
        ...
        output = DFT_SIM * diag(offset) * SV; % DFT in the wave domain
